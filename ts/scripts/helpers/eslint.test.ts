 ...
 * on an unchanged, lint-clean tree. The point of keeping it verbatim is that the extractor is proved
 * against ESLint's actual output rather than against a shape invented to suit it.
 */
const RULE_CRASH_STDERR = [
  ...
  'Occurred while linting F:\\dev\\projects\\paperio2\\ts\\src\\entities\\bot-ai.ts:347',
  'Rule: "no-empty"',
